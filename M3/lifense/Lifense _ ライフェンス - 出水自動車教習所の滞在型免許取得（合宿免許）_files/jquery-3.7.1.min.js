    ...
    (ce.extend = ce.fn.extend =
      function () {
        var e,
          ...
          u = arguments.length,
          l = !1;
        for ("boolean" == typeof a && ((l = a), (a = arguments[s] || {}), s++), "object" == typeof a || v(a) || (a = {}), s === u && ((a = this), s--); s < u; s++) if (null != (e = arguments[s])) for (t in e) (r = e[t]), "_proto_" !== t && a !== r && (l && r && (ce.isPlainObject(r) || (i = Array.isArray(r))) ? ((n = a[t]), (o = i && !Array.isArray(n) ? [] : i || ce.isPlainObject(n) ? n : {}), (i = !1), (a[t] = ce.extend(l, o, r))) : void 0 !== r && (a[t] = r));
        return a;
      }),
    ce.extend({
        ...
        return v(t)
          ...
          : ((e = kt(t)),
            this.each(function () {
              ...
              else (void 0 !== t && "boolean" !== a) || ((r = Ct(this)) && _.set(this, "_className_", r), this.setAttribute && this.setAttribute("class", r || !1 === t ? "" : _.get(this, "_className_") || ""));
            }));
      },
      hasClass: function (e) {
        var t,
